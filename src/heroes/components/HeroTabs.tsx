...
import { getCategoryColor, getStatusColor } from "../libs/utils";

interface Props {
  hero: Hero;
}

export const HeroTabs = ({ hero }: Props) => {
  return (
    <>
                ...
                <div className="space-y-4">
                  <div className="flex items-center gap-4">
                    ...
                    <div className="flex-1">
                      <Progress value={hero.strength * 10} className="h-4" />
                    </div>
                  ...
                  <div className="flex items-center gap-4">
                    ...
                    <div className="flex-1">
                      <Progress value={hero.speed * 10} className="h-4" />
                    </div>
                    <div className="w-12 text-right font-bold">
                      {hero.speed}/10
                    </div>
                  ...
                  <div className="flex items-center gap-4">
                    ...
                    <div className="flex-1">
                      <Progress value={hero.durability * 10} className="h-4" />
                    </div>
                    <div className="w-12 text-right font-bold">
                      {hero.durability}/10
                    </div>
